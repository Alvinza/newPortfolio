      ...
      <div className="max-w-3xl">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          <a
            ...
            className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 
            dark:hover:bg-gray-700 text-gray-800 dark:text-white px-4 py-2 rounded-md 
            transition-colors duration-300"
          >
            <FaGithub /> GitHub
          </a>
